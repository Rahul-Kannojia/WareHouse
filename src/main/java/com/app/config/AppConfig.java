...
import com.app.converter.WhUserConverter;
...
public class AppConfig  implements WebMvcConfigurer
{
	...
	@Autowired
	private WhUserConverter whconvert;
	...
	public LocalSessionFactoryBean sfObj() {
		...
		sf.setAnnotatedClasses(WhUserType.class,Uom.class,OrderMethod.class,ShipmentType.class, Item.class);
